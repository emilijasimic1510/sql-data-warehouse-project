...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Loading erp_location_info
        SET @start_time = GETDATE();
		PRINT '>> Truncating Table: silver.erp_location_info';
		TRUNCATE TABLE silver.erp_location_info;
		PRINT '>> Inserting Data Into: silver.erp_location_info';
