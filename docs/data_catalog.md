...
It consists of dimension tables and fact tables designed in a star schema.
...
subcategory	NVARCHAR(50)	A more detailed classification of the product within the category (e.g., Road Bikes).
...
sales_amount	INT	The total monetary value of the sale for the line item (e.g., 250).
